            ...
            <?php if(isset($comp_projects) && $comp_projects->num_rows > 0): ?>
                ...
                <div class="project-card new-design" style="position: relative;">
                    <a href="project-details.php?slug=<?php echo !empty($proj['slug']) ? urlencode($proj['slug']) : $proj['id']; ?>" style="display: block; overflow: hidden; height: 100%;">
                        <img loading="lazy" width="800" height="600" src="<?php echo !empty($proj['cover_image']) ? htmlspecialchars(ltrim($proj['cover_image'], '/')) : 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&q=80'; ?>" alt="<?php echo htmlspecialchars($proj['title']); ?>" style="transition: transform 0.5s ease; width: 100%; height: 100%; object-fit: cover;">
                    </a>
